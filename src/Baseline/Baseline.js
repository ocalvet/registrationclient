                                ...
                                {_.filter(this.state.registrationData, f => f.team.name !== "").map(r =>
                                    <div>
                                        <ListItem>
                                            ...
                                            <ListItemText primary={r.team.name} secondary={r.user.firstName + ' ' + r.user.lastName} />
                                        </ListItem>
                                        <List>
